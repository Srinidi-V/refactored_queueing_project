...
class Plots:
    ...
    @staticmethod
    def plot_departure(self, dd1k):

        plt.grid()
		# plt.style.use("fivethirtyeight")

        plt.xlabel(self.cust, fontsize=16, loc="center", color="#ff0033")
        plt.ylabel(self.time, fontsize=16, rotation=90, loc="center", color="#ff0033")
    ...
    @staticmethod
    def plot_arrival_time(self, dd1k):
    ...
    @staticmethod
    def plot_balking_list(self, dd1k):
